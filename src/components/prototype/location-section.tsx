...
const views = [
  { id: "google", label: "Google Maps", icon: FaLocationDot },
  { id: "3d", label: "Vista 3D", icon: FaCube },
  { id: "reference", label: "Plano", icon: FaMapLocationDot },
] as const;
      ...
      <div className="expo-location-layout">
        <div className="expo-location-info">
          ...
          <a className="expo-location-directions" href="https://www.google.com/maps/dir/?api=1&destination=-24.1828865,-65.3294615" target="_blank" rel="noopener noreferrer">
            <FaLocationArrow size={16} aria-hidden="true" /> Cómo llegar <FaArrowUpRightFromSquare size={14} aria-hidden="true" />
          </a>
        </div>
        <div className="expo-location-map" data-view={view}>
          <div className="expo-location-toolbar">
            ...
            <a className="expo-location-expand" href={externalUrl} target="_blank" rel="noopener noreferrer" aria-label="Abrir vista del mapa en una nueva pestaña"><FaArrowUpRightFromSquare size={16} aria-hidden="true" /></a>
          </div>
