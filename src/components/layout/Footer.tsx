        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 pb-12 border-b border-white/10 items-stretch">
          ...
          <div className="lg:col-span-6 flex flex-col justify-between space-y-4">
            ...
            <div className="space-y-4 pt-4 border-t border-white/5">
              ...
              {/* Redes Sociales Oficiales ExpoJuy (Centradas y con aire) */}
              <div className="flex items-center justify-center gap-3 text-xs text-gray-400 py-2.5 px-4 bg-white/[0.02] rounded-xl border border-white/5 shadow-inner">
                ...
                <a 
                  ...
                  className="w-8 h-8 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-300 hover:text-white hover:bg-gradient-to-tr hover:from-amber-500 hover:via-pink-500 hover:to-purple-600 transition-all hover:scale-105"
                >
                ...
                <a 
                  ...
                  className="w-8 h-8 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-300 hover:text-white hover:bg-[#1877F2] transition-all hover:scale-105"
                >
                  <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
                ...
                <a 
                  ...
                  className="w-8 h-8 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-300 hover:text-white hover:bg-[#19b9ca] transition-all hover:scale-105"
                >
          ...
          <div className="lg:col-span-6 flex flex-col justify-between space-y-4 lg:border-l lg:border-white/10 lg:pl-8">
            ...
            <div className="space-y-4 pt-4 border-t border-white/5">
              ...
              {/* Redes Sociales Oficiales Cámara de Comercio Exterior (Centradas y con aire) */}
              <div className="flex items-center justify-center gap-3 text-xs text-gray-400 py-2.5 px-4 bg-white/[0.02] rounded-xl border border-white/5 shadow-inner">
                ...
                <a 
                  ...
                  className="w-8 h-8 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-300 hover:text-white hover:bg-[#6424dc] transition-all hover:scale-105"
                >
                  <FaGlobe className="w-3.5 h-3.5" />
                </a>
              </div>
